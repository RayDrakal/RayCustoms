...
function s.initial_effect(c)
	...
	e0:SetValue(function(_,se) return se:IsHasType(EFFECT_TYPE_ACTIONS) end)
	c:RegisterEffect(e0)
	--Special Summon
...
function s.spcfilter(c)
	return c:IsReason(REASON_BATTLE|REASON_EFFECT) and c:IsPreviousLocation(LOCATION_ONFIELD) and c:IsHasType(TYPE_MONSTER)
end
