...
function s.attop(e,tp,eg,ep,ev,re,r,rp)
	...
	local tc=Duel.SelectMatchingCard(tp,s.attfilter,tp,LOCATION_HAND|LOCATION_DECK|LOCATION_EXTRA,LOCATION_ONFIELD|LOCATION_GRAVE|LOCATION_REMOVED,1,1,nil,e):GetFirst()
	if tc then
