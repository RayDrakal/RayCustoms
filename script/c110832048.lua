...
function s.thfilter(c)
	return c:IsSetCard(SET_BLUEWAVE) and c:IsType(TYPE_MONSTER) and c:IsAbleToHand()
end
...
function s.tdfilter(c)
	return c:IsSetCard(SET_BLUEWAVE) and c:IsSpellTrap() and c:IsAbleToDeck() and c:IsFaceup() and not c:IsCode(id)
end
