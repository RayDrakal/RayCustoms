...
function s.thfilter(c)
	return (c:IsCode(CARD_FD_DRAGONIS) or c:ListsCode(CARD_FD_DRAGONIS)) and c:IsAbleToHand()
end
...
function s.tdfilter(c)
	return c:IsAttribute(ATTRIBUTE_FIRE) and c:IsRace(RACE_DRAGON) and c:IsAbleToDeck() and c:IsFaceup()
end
