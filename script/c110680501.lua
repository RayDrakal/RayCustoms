...
function s.initial_effect(c)
	...
	e3a:SetValue(function(e,c) return c and not c:IsControler(e:GetHandlerPlayer()) end)
	c:RegisterEffect(e3a)
	local e3b=Effect.CreateEffect(c)
	e3b:SetType(EFFECT_TYPE_XMATERIAL)
	e3b:SetProperty(EFFECT_FLAG_PLAYER_TARGET)
	e3b:SetCondition(s.xyzcon)
	e3b:SetCode(EFFECT_CANNOT_RELEASE)
	e3b:SetRange(LOCATION_MZONE)
	e3b:SetTargetRange(0,1)
	e3b:SetTarget(function(e,c) return c==e:GetHandler() end)
	e3b:SetValue(1)
